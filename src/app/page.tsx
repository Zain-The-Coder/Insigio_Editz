...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• SERVICES SECTION â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <AnimatedSection>
              <div className="relative border border-charcoal-700/50 bg-charcoal-900/50 overflow-hidden">
                {/* Gold top accent */}
                <div className="h-1 bg-gradient-to-r from-cyan-700 via-cyan-500 to-cyan-700" />
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex items-baseline gap-2">
                        <span className="font-heading text-5xl md:text-6xl font-light text-slate-100">
                          $1,500
                        </span>
                        <span className="text-slate-200/40 font-body">â€”</span>
                        <span className="font-heading text-5xl md:text-6xl font-light text-slate-100">
                          $2,000
                        </span>
                      </div>
                      <p className="mt-2 text-slate-200/40 text-sm font-body">
                        per wedding film
                      </p>
                      <p className="mt-6 text-slate-200/60 font-body leading-relaxed">
                      ...
                      <a
                        href="#contact"
                        className="mt-8 inline-flex items-center justify-center gap-2 bg-cyan-600 hover:bg-cyan-500 text-charcoal-950 font-semibold px-8 py-4 text-sm uppercase tracking-widest transition-all duration-300 font-body"
                      >
                        Start Your Project
                        <ArrowRight size={16} />
                      </a>
                    ...
                    {/* Right: Deliverables */}
                    <div>
                      <span className="text-slate-200/40 text-xs uppercase tracking-[0.3em] font-body">
                        What&apos;s Included
                      </span>
                      <ul className="mt-6 space-y-4">
                        {deliverables.map((item) => (
                          <li key={item} className="flex items-start gap-3">
                            ...
                            />
                            <span className="text-slate-200/70 font-body text-sm">
                              {item}
                            </span>
                          </li>
                        ))}
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• CONTACT SECTION â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
